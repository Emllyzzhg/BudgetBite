...
/// Use Case 1: updates a university student's remaining food budget when money is spent or committed to a planned meal. Receives the current budget and spending amount, and apply the budget business rules
///
/// Business rules:
